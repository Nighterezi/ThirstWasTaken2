...
| `integrations/` | One script per optional mod: `create-water.jsonl`, `createfly-waterskin.jsonl`, `farmers-delight.jsonl`, `kaleidoscope-cookery.jsonl`, `supplementaries.jsonl`, `brewin-and-chewin.jsonl`, `cold-sweat.jsonl`, `cultural-delights.jsonl`, `fruits-delight.jsonl`, `expanded-delight.jsonl`, `serene-seasons.jsonl` |
