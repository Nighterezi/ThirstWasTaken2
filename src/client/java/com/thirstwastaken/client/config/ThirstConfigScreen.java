package com.thirstwastaken.client.config;
...
/**
 * Vanilla-styled editor for {@code config/thirstwastaken.json}.
 *
...
public final class ThirstConfigScreen extends OptionsSubScreen {
    ...
    public ThirstConfigScreen(Screen parent) {
        super(parent, Minecraft.getInstance().options, Component.translatable("thirstwastaken.config.title"));
    }
    ...
    protected void addOptions() {
        ...
        list.addHeader(Component.translatable("thirstwastaken.config.note"));
        list.addHeader(Component.translatable("thirstwastaken.config.category.depletion"));
        list.addSmall(
        ...
        list.addHeader(Component.translatable("thirstwastaken.config.category.drinking"));
        list.addSmall(
        ...
        list.addHeader(Component.translatable("thirstwastaken.config.category.purity"));
        list.addSmall(
        ...
        list.addHeader(Component.translatable("thirstwastaken.config.category.purity_chances"));
        ...
        list.addHeader(Component.translatable("thirstwastaken.config.category.hud"));
        list.addSmall(
        ...
        list.addHeader(Component.translatable("thirstwastaken.config.category.items"));
        list.addSmall(
                toggle("enable_keyword_matching", config.enableKeywordMatching,
                        value -> config.enableKeywordMatching = value));
        list.addBig(Button.builder(Component.translatable("thirstwastaken.config.open_file"),
                        button -> Util.getPlatform().openPath(
                                FabricLoader.getInstance().getConfigDir().resolve("thirstwastaken.json")))
                .build());
    }
    ...
    private static String translationKey(String key) {
        return "thirstwastaken.config." + key;
    }
}
