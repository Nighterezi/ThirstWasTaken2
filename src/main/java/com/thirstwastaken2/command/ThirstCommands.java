package com.thirstwastaken2.command;
                        ...
                        .then(Commands.argument("player", EntityArgument.player())
                                .executes(context -> {
                                    ...
                                    context.getSource().sendSuccess(() -> Component.translatable(
                                            "command.thirstwastaken2.query", data.thirst(), data.quenched()), false);
                                    return data.thirst();
                                })))
                        ...
                        .then(Commands.argument("players", EntityArgument.players())
                                .then(Commands.argument("enabled", BoolArgumentType.bool())
                                        .executes(context -> {
                                            ...
                                            String key = enabled
                                                    ? "command.thirstwastaken2.enable"
                                                    : "command.thirstwastaken2.disable";
